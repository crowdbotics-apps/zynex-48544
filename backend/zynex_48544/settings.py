"""
Django settings for zynex_48544 project.
...
WSGI_APPLICATION = 'zynex_48544.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Zynex Support <support@zynex-48544.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "zynex_48544 API",
    "DESCRIPTION": "API documentation for zynex_48544 App",
    "VERSION": "v1",
}
